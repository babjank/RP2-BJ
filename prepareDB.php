...
try
{
	$st = $db->prepare( 'INSERT INTO IZVIDAC(OIB, IME, PREZIME, ADRESA, DATUM_UPISA, IME_PATROLE, EMAIL, ULOGIRAN) VALUES (:oib, :ime, :prezime, :adresa, :datum, :patrola, \'a@b.com\', \'1\')' );

	$st->execute( array( 'oib' => 64226562901, 'ime' => 'Fensi', 'prezime' => 'Antolic', 'adresa' => 'Ante Jaksica 18', 'datum' => "2017-10-01", 'patrola' => 'Nebula' ) );
	$st->execute( array( 'oib' => 92568529652, 'ime' => 'Mateo', 'prezime' => 'Matosevic', 'adresa' => 'Ante Jaksica 9', 'datum' => "2016-10-01", 'patrola' => 'Nebula' ) );
	$st->execute( array( 'oib' => 19474757537, 'ime' => 'Leona', 'prezime' => 'Krapovic', 'adresa' => 'Gjalskog 32', 'datum' => "2017-12-01", 'patrola' => 'Nebula' ) );
	$st->execute( array( 'oib' => 21385368754, 'ime' => 'Maja', 'prezime' => 'Boric', 'adresa' => 'Gjalskog 37', 'datum' => "2017-11-01", 'patrola' => 'Nebula' ) );
	$st->execute( array( 'oib' => 43654875476, 'ime' => 'Mak', 'prezime' => 'Simur', 'adresa' => 'Kolarova 4', 'datum' => "2017-04-01", 'patrola' => 'Nebula' ) );
	$st->execute( array( 'oib' => 42448434841, 'ime' => 'Tara', 'prezime' => 'Denardis', 'adresa' => 'V. Vidrica 10', 'datum' => "2016-10-01", 'patrola' => 'Enelo' ) );
	$st->execute( array( 'oib' => 56413295644, 'ime' => 'Sara', 'prezime' => 'Baksa', 'adresa' => 'V. Vidrica 31', 'datum' => "2017-10-01", 'patrola' => 'Enelo' ) );
	$st->execute( array( 'oib' => 41451852547, 'ime' => 'Sara', 'prezime' => 'Kokolic', 'adresa' => 'Kolarova 10', 'datum' => "2016-10-01", 'patrola' => 'Enelo' ) );
	$st->execute( array( 'oib' => 23536562901, 'ime' => 'Davor', 'prezime' => 'Vitez', 'adresa' => 'Kolarova 9', 'datum' => "2017-10-01", 'patrola' => 'Enelo' ) );
	$st->execute( array( 'oib' => 93467529632, 'ime' => 'Lovro', 'prezime' => 'Antolic', 'adresa' => 'Ante Jaksica 18', 'datum' => "2016-10-01", 'patrola' => 'Enelo' ) );
	$st->execute( array( 'oib' => 14564757537, 'ime' => 'Lana', 'prezime' => 'Echert', 'adresa' => 'Ante Jaksica 2', 'datum' => "2018-10-01", 'patrola' => 'Enelo' ) );
	$st->execute( array( 'oib' => 14685368754, 'ime' => 'Lena', 'prezime' => 'Echert', 'adresa' => 'Ante Jaksica 2', 'datum' => "2018-10-01", 'patrola' => 'Enelo' ) );
	$st->execute( array( 'oib' => 27373636358, 'ime' => 'Leonarda', 'prezime' => 'Kokolic', 'adresa' => 'Kolarova 10', 'datum' => "2015-10-01", 'patrola' => 'Servali' ) );
	$st->execute( array( 'oib' => 32876326576, 'ime' => 'Neo', 'prezime' => 'Kokolic', 'adresa' => 'Kolarova 10', 'datum' => "2016-10-01", 'patrola' => 'Servali' ) );
	$st->execute( array( 'oib' => 84358736621, 'ime' => 'Nia', 'prezime' => 'Lovric', 'adresa' => 'Vranicka 36', 'datum' => "2016-10-01", 'patrola' => 'Servali' ) );
	$st->execute( array( 'oib' => 84358736929, 'ime' => 'Leona', 'prezime' => 'Bogovic', 'adresa' => 'Ilica 229', 'datum' => "2017-10-01", 'patrola' => 'Servali' ) );
	$st->execute( array( 'oib' => 14347529632, 'ime' => 'Ela', 'prezime' => 'Belina', 'adresa' => 'Gjalskog 74', 'datum' => "2017-10-01", 'patrola' => 'Servali' ) );
	$st->execute( array( 'oib' => 81211322453, 'ime' => 'Domagoj', 'prezime' => 'Benkovic', 'adresa' => 'Kolarova 16', 'datum' => "2014-12-01", 'patrola' => NULL) );
	$st->execute( array( 'oib' => 11912355361, 'ime' => 'Bjanka', 'prezime' => 'Basic', 'adresa' => 'Remetinecka cesta 7a', 'datum' => "2012-03-01", 'patrola' => NULL ) );
	$st->execute( array( 'oib' => 19124847284, 'ime' => 'Viktoria', 'prezime' => 'Krapovic', 'adresa' => 'V. Vidrica 10', 'datum' => "2010-10-01", 'patrola' => NULL ) );
	$st->execute( array( 'oib' => 52421322457, 'ime' => 'Nevena', 'prezime' => 'Nikic', 'adresa' => 'Ante Jaksica 11', 'datum' => "2010-05-01", 'patrola' => NULL ) );
...
try
{
	$st = $db->prepare( 'INSERT INTO AKTIVNOST(DATUM_ODRZAVANJA, MJESTO, CIJENA, BROJ_CLANOVA) VALUES (:datum, :mjesto, :cijena, :broj)');

	$st->execute( array( 'datum' => "2019-06-27", 'mjesto' => 'PD Hunjka', 'cijena' => 10, 'broj' => 4) );
	$st->execute( array( 'datum' => "2019-06-15", 'mjesto' => 'Jarun', 'cijena' => 15, 'broj' => 1) );
}
