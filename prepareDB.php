...
try
{
	...
	$st->execute( array( 'oib' => 11912355361 , 'datum' => "2019-06-27", 'mjesto' => 'Jarun', 'cijena' => 30, 'broj' => 10, 'opis' => 'Gradsko orjentacijsko natjecanje za izviđače.', 'sirina' => 45.7799973, 'duzina' => 15.9128448) );
}
...
try
{
	...
	$st->execute( array( 'id_aktivnost' => 3, 'oib' => 11912355361, 'uloga' => 'voda izleta' ) );
	$st->execute( array( 'id_aktivnost' => 3, 'oib' => 64226562901, 'uloga' => 'sudionik' ) );
	$st->execute( array( 'id_aktivnost' => 3, 'oib' => 19474757537, 'uloga' => 'sudionik' ) );
	$st->execute( array( 'id_aktivnost' => 3, 'oib' => 92568529652, 'uloga' => 'sudionik' ) );
	$st->execute( array( 'id_aktivnost' => 3, 'oib' => 14347529632, 'uloga' => 'sudionik' ) );
	$st->execute( array( 'id_aktivnost' => 3, 'oib' => 84358736929, 'uloga' => 'sudionik' ) );
	$st->execute( array( 'id_aktivnost' => 3, 'oib' => 84358736621, 'uloga' => 'sudionik' ) );
	$st->execute( array( 'id_aktivnost' => 3, 'oib' => 23536562901, 'uloga' => 'sudionik' ) );
	$st->execute( array( 'id_aktivnost' => 3, 'oib' => 93467529632, 'uloga' => 'sudionik' ) );
	$st->execute( array( 'id_aktivnost' => 3, 'oib' => 14564757537, 'uloga' => 'sudionik' ) );
