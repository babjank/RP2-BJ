...
if( $has_tables )
{
	exit( 'Tablice dz2_users / dz2_projects / dz2_members veÄ‡ postoje. ObriÅ¡ite ih pa probajte ponovno.' );
}
...
try
{
	...
	$st->execute( array( 'id' => 1, 't' => 'Igra - Go', 'a' => 'Implementirat Ä‡emo Go u kojem korisnik moÅ¾e igrati protiv AI-ja.', 'no' => 3, 'st' => 'open' ) ); // mirko
	$st->execute( array( 'id' => 2, 't' => 'Novi Fejsbuk', 'a' => 'U ovom projektu napravit Ä‡emo novi Fejsbuk koji Ä‡e joÅ¡ skupljati joÅ¡ viÅ¡e informacija o svojim korisnicima i koji Ä‡e
                joÅ¡ ÄeÅ¡Ä‡e i joÅ¡ sluÄajnije curiti te informacije treÄ‡im stranama.', 'no' => '5', 'st' => 'open' ) ); // ana
	$st->execute( array( 'id' => 3, 't' => 'Web-aplikacija za recepte', 'a' => 'Napravit Ä‡emo aplikaciju sa svim receptima iz kuharice moje bake.', 'no' => 4, 'st' => 'open' ) ); // maja
 	$st->execute( array( 'id' => 1, 't' => 'Kao Amazon, ali bolje', 'a' => 'Jeff Bezos nema pojma, naÅ¡ Amazon Ä‡e biti puno bolji.', 'no' => 2, 'st' => 'closed' ) ); // mirko
	$st->execute( array( 'id' => 4, 't' => 'Projekt za RP2', 'a' => 'VeÄ‡ Ä‡emo neÅ¡to smisliti, prvo idemo okupiti tim.', 'no' => 4, 'st' => 'open' ) ); // slavko
}
